...
\title[RegTek]{Egenskaper med prosessen} % The short title appears at the bottom of every slide, the full title is only on the title page
%\subtitle{Subtitle}
...
\begin{frame}
	...
	\begin{itemize}
		\item Det vi kaller prosessen kan oppføre seg på ulike måter 
		\item Vi skal se næremere på to vanlige måter 
		\item Selvregulerende prosess
		\item Integrerende prosess
	\end{itemize}
		\end{column}
		\begin{column}{0.5\textwidth}
	$$\includegraphics[width=0.9\textwidth]{cont05.eps}$$
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	$$\includegraphics[height=6cm]{process_22.eps}$$
\end{frame}
...
\begin{frame}
	...
	$$\includegraphics[width=1\textwidth]{process_23.eps}$$
		\end{column}
	\end{columns}
...
\begin{frame}
	\frametitle{Prosessforsterkning - påvirkning fra transmitterens måleområde}
	\begin{columns}
		\begin{column}{0.2\textwidth}
		\end{column}
		\begin{column}{0.8\textwidth}
	$$\includegraphics[width=1\textwidth]{process_25.eps}$$
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.8\textwidth}
	$$\includegraphics[width=1\textwidth]{process_26.eps}$$
		\end{column}
	\end{columns}
\end{frame}
%
...
\begin{frame}
	\frametitle{Prosessforsterkning - Variabel forsterkning med varierende prosess verdi}
...
\begin{frame}
	...
	$$\includegraphics[height=4cm]{process_06.eps}$$
\end{frame}
\begin{frame}
	\frametitle{Prossessens tidskonstant}
...
\end{frame}
\begin{frame}
	\frametitle{Differensialligningen}
...
\begin{frame}
	\frametitle{Løsning på differensialligningen}
...
%
	\begin{frame}{test}
		$$\includegraphics[height=7cm]{process_20.eps}$$
	\end{frame}
%
