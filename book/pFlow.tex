...
Rør med diameter 20cm\\
Strømning på 75l/s\\
Hvilken hastighet har strømningen?
...
%
			$$\overline{v} = {Q \over A} = {{75 {l  \over \hbox{s}}} \over {{\pi {0.02m\over 2}^2} \hbox{ m}^2}} = 2.4 m/s$$
%
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	$$\includegraphics[height=4cm]{flow10.eps}
...
\begin{frame}
	...
	$$\includegraphics[height=5cm]{flow29.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[width=1\textwidth]{flow30.eps}$$
	$$\includegraphics[width=1\textwidth]{flow31.eps}$$
\end{frame}
...
\begin{frame}
	\frametitle{Fagmessig montering i horisontalt rør}
...
\begin{frame}
	\frametitle{Fagmessig montering i vertikalt rør}
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{magflow9.eps}$$
\end{frame}
%
