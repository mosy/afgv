...
\title[Temperatur]{Målesystemer for nivå} % The short title appears at the bottom of every slide, the full title is only on the title page
%\subtitle{Subtitle}
...
$$\includegraphics[height=0.8\textheight]{sightglass_1.eps}$$
\end{frame}
...
$$\includegraphics[height=0.8\textheight]{level20.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level21.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level22.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level24.eps}$$
\end{frame}
%
%\filbreak
%
...
$$\includegraphics[height=0.8\textheight]{level25.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level03.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level04.eps}$$
\end{frame}
%
%\filbreak
%
...
$$\includegraphics[height=0.8\textheight]{level05.eps}$$
\end{frame}
%
%\filbreak
%
...
$$\includegraphics[height=0.8\textheight]{level_tape_1.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level06.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level26.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level65.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.7\textheight]{level01.eps}$$
...
$$\includegraphics[height=0.8\textheight]{hydrostatic_level_2}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{level02.eps}$$
\end{frame}
%
...
$$\includegraphics[height=0.8\textheight]{rosemount_hydrostatic.eps}$$
\end{frame}
%
%\vskip 10pt
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level61.eps}$$
\end{frame}
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level62.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level16.eps}$$
\end{frame}
%
%\label{Purged_level}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level67.eps}$$
\end{frame}
%
%
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{hydrostatic_level_1}$$
\end{frame}
%
%\filbreak
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level17x01.eps}$$
\end{frame}
%
...
\textbf{in tank} & \textbf{range} & (cm of water) & (PSI) & (mA) \cr
		\hline
0 m & 0 \% & 1000 cm W.C. & 0.77 bar & 4 mA \cr
		\hline
7 m & 50 \% & 1700 cm W.C. & 1.32 bar & 12 mA \cr
		\hline
14 m & 100 \% & 2400 cm W.C. & 1.86 bar & 20 mA \cr
		\hline
	\end{tabular}
\end{center}	
\end{frame}
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level18x01.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level19.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level07.eps}$$
\end{frame}
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level08.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level09.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level10.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level64.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level63.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level68x01.eps}$$
\end{frame}
\begin{frame}
	\frametitle{Hydrostatisk måling av nivå i lukket tank}
	\begin{center}
...
\textbf{Gasoline level} & \textbf{Percent} & \textbf{Differential pressure} & \textbf{Transmitter} \cr
 & \textbf{of range} & \textbf{at transmitter} & \textbf{output} \cr
			\hline
0 m & 0 \% & $-1.08$ bar & 4 mA \cr
			\hline
2.5 m & 25 \% & $-0.92$ bar & 8 mA \cr
			\hline
5 m & 50 \% & $-0.76$ bar & 12 mA \cr
			\hline
7.5 m & 75 \% & $-0.60$ bar & 16 mA \cr
			\hline
10 m & 100 \% & $-0.43$ bar & 20 mA \cr
			\hline
		\end{tabular}
	\end{center}	
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level11.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level12.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level13.eps}$$
\end{frame}
%
%\filbreak
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level69.eps}$$
\end{frame}
%
...
\begin{frame}
	...
	$$\includegraphics[height=7cm]{level34.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{ultrasonic_level_transmitter.eps} \hskip 30pt \includegraphics[height=7cm]{ultrasonic_level_transducer.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level75.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level35.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level39.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level37.eps}$$
\end{frame}
%
%\filbreak
%
...
$$\includegraphics[height=7cm]{level41.eps}$$
\end{frame}
%
%\vskip 10pt
%
...
$$\includegraphics[height=7cm]{level36.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level38.eps}$$
\end{frame}
%
...
$$\includegraphics[width=1\textwidth]{level51.eps}$$
\end{frame}
%
...
$$\includegraphics[width=1\textwidth]{level52.eps}$$
\end{frame}
%
...
\begin{frame}
	\frametitle{Nivåmåling basert på refleksjon av radarbølger}
%
$$\includegraphics[height=7cm]{level53.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level60.eps} \hskip 30pt \includegraphics[height=7cm]{level58.eps}$$
\end{frame}
...
$$\includegraphics[height=7cm]{level59.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{loadcell_2.eps}$$
\end{frame}
%
%\filbreak
%
...
$$\includegraphics[height=7cm]{loadcell_4.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{loadcell_3.eps}$$
\end{frame}
%
...
$$\includegraphics[height=7cm]{level42.eps}$$
\end{frame}
%
