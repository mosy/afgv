...
En Allen-Bradley Logix5000 PLS blir brukt til {\aa} starte og stoppe en luftkompressor. Denne styres av impulsbrytere i tilleg til h{\o}y og lavtrykks brytere (PSH og PSL). Analyser programmet for forklar hvordan det skal virke. 

$$\epsfbox{i02346x01.eps}$$

\filbreak

$$\epsfbox{i02346x02.eps}$$

Ha spesiell fokus p{\aa} {\aa} besvare f{\o}lgende sp{\o}rsm{\aa}l. 

\medskip
\item{$\bullet$} Avgj{\o}r den normale posisjonen til bryterene som er tilkoblet PLS-en. (Om de er NO eller NC) Ut fra funksjonen de har i programmet. 
\item{$\bullet$} Hvorfor er det viktig at en akumulerende timer blir brukt til {\aa} kalkulere total driftstid? 
\medskip
