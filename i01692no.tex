...
%In a cascade control system, which loop must {\it always} have shorter dead and lag times, the master (primary) or the slave (secondary)?  Explain why
I et kaskadekoblet reguleringssystem, hvilken sl{\o}yfe m{\aa} ha kortest d{\o}tid og tidskonstand, master eller slave regulatoren? Forklar hvorfor. 

\vskip 20pt \vbox{\hrule \hbox{\strut \vrule{} {\bf Suggestions for Socratic discussion} \vrule} \hrule}

\medskip
\item{$\bullet$} Explain how the lag and dead times of each loop may be quantitatively measured in a live process.
\medskip
