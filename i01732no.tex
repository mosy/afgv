...
Mange kjemikalier brukes for {\aa} behandle vann, f{\o}r det blir drikkevann. I koaguleringssteget blir kjemikalier tilsatt for {\aa} f{\aa} suspendert stoff til {\aa} koagulere til st{\o}rre partikler kalt fnokker. Fnokker er sedimentere eller lettere kunne filtreres. Disse kjemikaliene m{\aa} blandes i et bestemt forhold. 

$$\epsfbox{i01732x01.eps}$$
...
Om innl{\o}psvannet sin str{\o}mning eller sammensetning aldri forandrer seg. Kan settpunktet for tilsetting av kjemikalier v{\ae}re konstant. 

Men om str{\o}mningne p{\aa} innl{\o}psvannet varierer, m{\aa} settpunktene varieres. Dette vil v{\ae}re tungvit og arbeidskrvende for operat{\o}ren, kan du komme opp med en l{\o}sning for forholdsregulering av dette systemet?
