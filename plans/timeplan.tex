...
% Style for hours
\tikzstyle{hour}=[draw, rectangle, minimum height=1 cm, minimum width=1.5 cm, fill=gray!30,anchor=north east]
...
\tikzstyle{Auto}=[2hours,fill=red!20]
\tikzstyle{Elenergi}=[2hours,fill=blue!20]
\tikzstyle{Mek}=[2hours,fill=blue!10]
...
\node[day] (lundi) at (1,8) {Mandag};
\node[day] (mardi) [right = of lundi] {Tirsdag};
\node[day] (mercredi) [right = of mardi] {Onsdag};
\node[day] (jeudi) [right = of mercredi] {Torsdag};
\node[day] (vendredi) [right = of jeudi] {Fredag};
\node[hour] (8-9) at (1,8) {0805-0850};
\node[hour] (9-10) [below = of 8-9] {0850-0935};
\node[hour] (10-11) [below= of 9-10] {0950-1035};
\node[hour] (11-12) [below = of 10-11] {1035-1120};
...
\node[Auto] at (1,10) {Auto\\D426};
\node[Auto] at (1,8) {Auto};
\node[Auto] at (2,8) {Auto};
\node[Auto] at (4,8) {Auto};
\node[Auto] at (5,10) {Physique};
\node[Elenergi] at (2,10) {Elenergi\\D426\\Torbjørn};
\node[Elenergi] at (2,14) {Elenergi};
\node[Elenergi] at (3,8) {Elenergi};
\node[Elenergi] at (4,10) {Elenergi};
\node[Elenergi] at (5,8) {Elenergi};
\node[Mek] at (1,14) {Mekanisk\\D426\\Jon};
\node[Mek] at (1,16) {Mekanisk\\D426\\Jon};
\node[Mek] at (2,16) {Mekanisk\\D426\\Jon};
\node[Mek] at (3,10) {Mekanisk\\D426\\Jon};
\node[Mek] at (5,14) {Mekanisk\\D426\\Jon};
\node[Mek] at (5,16) {Mekanisk\\D426\\Jon};
