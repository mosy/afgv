...
echo "\vskip 50pt \centerline{This page intentionally left blank} \vskip 50pt \vfil \eject" >> $OUTPUT # This line ensures answers will never be printed on same page as questions (when the exam is double-side printed)
