...
\vspace{1cm}
\\
\includegraphics[width=0.4\textwidth]{../output/nogpl/Trykkprve02.png}\vspace{1cm}
\item (3p)En motor med følende merkeskilt er koblet til et vanlig TN nett
i Norge. \\
 \includegraphics[width=0.3\textwidth]{../output/nogpl/Nameplate01.png}\\
...
pil i?\\
\includegraphics[width=0.2\textwidth]{../output/nogpl/estop.png}
...
\\
\includegraphics[width=1\textwidth]{../output/nogpl/Kornsilo.png}\\
\vspace{2cm}
\vspace{2cm}
...
\end{enumerate}
\end{enumerate}
\includepdf{../output/nogpl/YaskawaModbusTable.pdf}

\includepdf[pages=-]{../output/nogpl/Prve01Tegninger.pdf}
\end{document}
