...
-S1 betjenes?\\
\includegraphics[width=1\textwidth]{../nogpl/releer01}\\
\end{enumerate}
...
a) \includegraphics[width=6cm]{../nogpl/revreg.png}\hspace{2cm}b)
\includegraphics[width=6cm]{../nogpl/Direktevirkenderegulator.png}
