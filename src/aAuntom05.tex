...
\vskip 2.5pt 
a) \\
Bildet viser en nødstopp, hvilken betydning har sirkelen med en pil i?
\vskip 2.5pt 
...
\vskip 2.5pt 
b) \\
Hvilke to hoveddeler består en mekaniskgrensebryter av?
\vskip 2.5pt 
\begin{tikzpicture}
...
\vskip 2.5pt 
c) \\
Sett navn på de ulike typer aktuatorer.
\vskip 25pt 
...
\oppgave{}%3
\vskip 25pt 
To endebrytere skal tilkobles h.h.v. \texttt{Ix.3} og \texttt{Ix.6} på en Siemens SM-321 DI inngangsmodul(model 6ES7321-1BL00-0AA0). Tegn de nødvendige koblingene. Det internekoblingsskjemaet for (\texttt{Ix.0}) vises som en referanse for alle inngangene.
...
\oppgave{}%5
\vskip 2.5pt 
Tegn og forklar virkemåten til en magnetisk sensor?
\vskip 5pt 
\begin{tikzpicture}
...
\vskip 2.5pt 
a) \\
Tegn og forklar virkemåten til en induktiv sensor?
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,23) ;
\end{tikzpicture}
...
\vskip 2.5pt 
a) \\
Tegn og forklar virkemåten til en fotocelle med refleks
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,23) ;
\end{tikzpicture}
...
\vskip 2.5pt 
a) \\
Tegn og forklar virkemåten til et lysgitter
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,23) ;
\end{tikzpicture}
...
>>>>>>> 6bd5c76ae2d0b54a77767acf6f325485ad03168c
