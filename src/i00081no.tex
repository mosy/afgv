...
Anta at en trykktransmitter har et måleomfang på 0-100 PSI. Den har 4-20mA utgang. En har fått følende data fra en 5-punkts opp/ned kalibrering 
...
Tegn instrumentets overføringsfunksjon i grafen nedenfor. Tegn også den ideelle overføringsfunksjonen. Avgjør så hvilen kalibreringsfeil den har ({\it zero shift}, {\it span shift}, and/or {\it linearity}).
