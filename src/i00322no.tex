...
Lag en enkel 5-punkts kalibreringstabell (0\%, 25\%, 50\%, 75\% og 100\%) for nivåtransmitteren i dette tilfellet. Anta en kalibreringstoleranse på +/- 0.5\%:
...
%
% First row
Prosess- & Prosent av & Differanse- & Utsignal & Utsignal & Utsignal \cr
%
% Another row
nivå (in) & span (\%) & trykk ("W.C.) & ideelt (PSI) & min. (PSI) & maks. (PSI) \cr
%
\noalign{\hrule}
%
% Another row
