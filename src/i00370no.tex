...
Anta at du skal feilsøke en volumfortrengningsmåler med pulsutgang (én puls per 20 gallon), koblet til en elektronisk teller for total vannmengde over tid. Telleren krever et {\it pulserende} signal for å telle opp (stabil ``lav'' eller stabil ``høy'' gir ingen økning i telleren), og av en eller annen grunn teller den ikke korrekt selv om vi vet at det faktisk er vannflow. Med digitalt multimeter måler du konstant 0 volt mellom terminalene {\bf C} og {\bf D}, mens du venter lenge nok til at flowmålerbryteren skal ha pulset minst én gang:

$$\includegraphics[width=15.5cm]{i00370x01.eps}$$
