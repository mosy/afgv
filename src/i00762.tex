...
Suppose a voltmeter registers 0 volts between test points {\bf C} and {\bf A} while the pushbutton is released (not pressed), and also 0 volts between the same test points while the pushbutton is pressed:
