...
Suppose we had a single-ported globe valve such as this controlling fluid flow, with inlet and outlet pressures as shown in the illustration.  If the plug has a cross-sectional area of 3 square inches, how much force will be exerted on the plug by the fluid?  In which direction will this force be exerted?

$$\includegraphics[width=15.5cm]{i00772x01.eps}$$

\filbreak

Now suppose we replace the single-ported globe valve with a {\it double-ported} globe valve of similar operating characteristics.  Given the same inlet and outlet pressures, how much (net) force will be exerted on the plugs by the fluid?  Assume the upper plug has a cross-sectional area of 3 square inches, and the lower plug a cross-sectional area of 2 square inches:

$$\includegraphics[width=15.5cm]{i00772x02.eps}$$
