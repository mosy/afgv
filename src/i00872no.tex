...
\centerline{\bf Mettet damptabell}
...
%
% First row
{\bf Temperatur} & {\bf Trykk} & {\bf Følbar varme i} & {\bf Fordampningsvarme i} & {\bf Total varme} \cr
{\bf (grader F)} & {\bf (PSIA)} & {\bf væske (BTU/lb)} & {\bf damp (BTU/lb)} & {\bf (BTU/lb)} \cr
%
\noalign{\hrule}
%
% Another row
...
\centerline{\bf Mettet damptabell (continued)} 
