...
\item{$(2)$} Identify a practical application for {\it feedforward} control and explain how it works.

\vskip 20pt

\item{$(3)$} Calculate the pneumatic pressure in a 3-15 PSI range corresponding to 45 percent.
