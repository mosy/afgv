...
Suppose the solenoid valve refuses to energize when the pushbutton switch is pressed.  A voltmeter registers 24 volts between test points {\bf C} and {\bf D} in the circuit when the pushbutton is pressed and 0 volts between those same test points when it is released (i.e. not being pressed):

$$\includegraphics[width=15.5cm]{i01055x01.eps}$$
