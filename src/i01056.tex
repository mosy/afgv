...
Suppose the solenoid valve refuses to energize when the pushbutton switch is pressed.  A voltmeter registers 0 volts between test points {\bf C} and {\bf D} regardless of the pushbutton's state (either pressed or released):

$$\includegraphics[width=15.5cm]{i01056x01.eps}$$
