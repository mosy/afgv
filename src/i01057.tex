...
Suppose the solenoid valve remains energized at all times, refusing to de-energize when the pushbutton switch is pressed.  A voltmeter registers 24 volts between test points {\bf C} and {\bf D} regardless of the pushbutton's state (either pressed or released):

$$\includegraphics[width=15.5cm]{i01057x01.eps}$$
