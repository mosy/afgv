...
Suppose an NDIR gas analyzer is proposed for measuring the concentration of ammonia (NH$_{3}$) gas in a stream containing a high percentage of nitrogen dioxide (NO$_{2}$) gas.  The infrared spectra of these two gases are shown below:

$$\includegraphics[width=15.5cm]{i01124x01.eps}$$
...
\vskip 5pt
\item{} Luft detector cells: \underbar{\bf ammonia} (NH$_{3}$) gas
\vskip 5pt
\item{} Filter cells: \underbar{\bf nitrogen dioxide} (NO$_{2}$) gas
\end{itemize}
