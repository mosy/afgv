...
Tegn inn alle nødvendige forbindelsesledninger for å teste {\it kun} funksjonen tidsforsinket overstrøm (51). En justerbar AC-strømkilde gir innmating til releet, mens en lyspære brukes for å indikere når releets utløserkontakt(er) har sluttet.
...
Merk: det er også tillatt å koble den justerbare AC-strømkilden til terminal 8 og 9, i stedet for 3 og 9. Dette vil energisere både CO- og IIT-spolene, men CO-funksjonen blir fortsatt testet tilfredsstillende. Polaritet er irrelevant både for AC-teststrømkilden og for 24 VDC-utløserindikator-kretsen med lyspære.
