...
Konverter følgende regulatorinnstillinger (i enheter av proporsjonalbånd) til enheter av gain (K$_{p}$):
...
\begin{itemize}
\item{} Vis hvordan du kan anslå svarene i disse konverteringene uten å bruke kalkulator.
\end{itemize}
