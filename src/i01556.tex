...
%
% Another row
Measure $R_{AB}$ with power applied &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{DF}$ with power applied &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{CF}$ with power applied &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{AB}$ with source disconnected from {\bf A} &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{DF}$ with source disconnected from {\bf A} &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{CF}$ with source disconnected from {\bf B} &  &  \cr
%
\noalign{\hrule}
%
% Another row
Measure $R_{CF}$ with wire disconnected between {\bf A} and {\bf C} &  &  \cr
%
\noalign{\hrule}
} % End of \halign 
}$$ % End of \vbox
