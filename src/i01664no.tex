...
Hvilken type prosess (selvregulerende eller integrerende) er naturlig stabil når regulatoren står i «manuell» modus, og hvilken type prosess er ikke det? Forklar hvorfor.

\vskip 10pt

Hvilken type prosess (selvregulerende eller integrerende) kan teoretisk reguleres med bare P-virkning (kun proporsjonalvirkning)? Forklar hvorfor.

\underbar{file i01664no}
%(END_QUESTION)
