...
\begin{itemize}
\item{} For those who have studied flowmeter technology, identify the types of flowmeters shown in this diagram and explain how each of them works.
\item{} After implementing your control strategy, analyze the effects of the raw water flow transmitter failing with a {\it low} signal.
\end{itemize}
