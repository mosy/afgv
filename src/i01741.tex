...
Configure a PID simulator for a {\bf liquid level control} application.  Perform an open-loop test (stroking the control valve and examining the process variable response), and sketch the results:

$$\includegraphics[width=15.5cm]{i01741x01.eps}$$
...
%INDEX% Control, PID tuning: computer simulation exercise (liquid level control)
