...
This pressure control system has a problem.  The indicating controller (PIC) shows a negative pressure (less than 0 inches WC) even though the pressure gauge (PG) registers 30 inches WC.  A voltmeter connected between terminals 9 and 10 registers 24 VDC:

$$\includegraphics[width=15.5cm]{i01758x01.eps}$$
