...
This pressure control system has a problem.  The indicating controller (PIC) shows a negative pressure (less than 0 inches WC) even though the pressure gauge (PG) registers 30 inches WC.  A voltmeter connected between terminals 3 and 4 registers 3.4 VDC:

$$\includegraphics[width=15.5cm]{i01762x01.eps}$$
