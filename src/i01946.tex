...
Suppose the lamp refuses to light up regardless if the pushbutton switch is pressed or not.  A voltmeter registers 12 volts between test points {\bf E} and {\bf F} in the circuit while the pushbutton is released (not pressed):

$$\includegraphics[width=15.5cm]{i01946x01.eps}$$
