...
Suppose the lamp refuses to light up regardless if the pushbutton switch is pressed or not.  A voltmeter registers 12 volts between test points {\bf E} and {\bf B} in the circuit while the pushbutton is pressed:

$$\includegraphics[width=15.5cm]{i01947x01.eps}$$
