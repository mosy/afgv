...
This split-range control valve system has a problem: neither valve responds to the controller's output.  Your first voltage test registers 24 volts between points {\bf C} and {\bf D}, with hand controller HC-42 (the 4-20 mA current source) set in manual mode at 50\% output:

$$\includegraphics[width=15.5cm]{i01986x01.eps}$$
