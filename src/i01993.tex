...
This split-range control valve system has a problem: valve HV-42b responds to the controller's output, but valve HV-42a does not.  Your first voltage test registers 0 volts between points {\bf A} and {\bf E}, with hand controller HC-42 (the 4-20 mA current source) set in manual mode at 50\% output:

$$\includegraphics[width=15.5cm]{i01993x01.eps}$$
