...
Suppose the lamp refuses to light up regardless if the pushbutton switch is pressed or not.  A voltmeter registers 0 volts between test points {\bf C} and {\bf D} in the circuit while the pushbutton is released (not pressed):

$$\includegraphics[width=15.5cm]{i02096x01.eps}$$
