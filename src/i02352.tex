...
A newly constructed PLC-controlled motor starter system refuses to work -- the motor shaft does not turn after the operator presses the ``Start'' switch and waits.  After this, you measure 0 volts AC between the PLC power supply's L2 terminal and the terminal labeled ``Y0'' on the PLC output card.  A laptop PC shows the PLC program as it exists in memory, but without any colored status highlighting:

$$\includegraphics[width=15.5cm]{i02352x01.eps}$$
