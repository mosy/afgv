...
$$\includegraphics[width=15.5cm]{i02362x01.eps}$$
...
\begin{itemize}
\item{} $E_{line} =$ 220 V
\item{} $I_{line} =$ 0.482 A
\item{} $E_{phase(source)} =$ 220 V
\item{} $I_{phase(source)} =$ 0.278 A
\item{} $E_{phase(load)} =$ 220 V
\item{} $I_{phase(load)} =$ 0.278 A
\item{} $P_{total} =$ 183.8 W
\end{itemize}
