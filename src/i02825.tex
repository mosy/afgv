...
This temperature control system has a problem.  The indicating controller (TIC) shows that the furnace temperature is -375 $^{o}$F.  A voltmeter connected between terminals 1 and 2 registers 24 VDC:

$$\includegraphics[width=15.5cm]{i02825x01.eps}$$
