...
Suppose the solenoid valve refuses to energize when the pushbutton switch is pressed.  A voltmeter registers 24 volts between test points {\bf E} and {\bf F} in the circuit while the pushbutton is released (i.e. not being pressed):

$$\includegraphics[width=15.5cm]{i03130x01.eps}$$
