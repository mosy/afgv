...
$$\includegraphics[width=15.5cm]{i03306x01.eps}$$
...
This is a {\it reverse-acting}, {\it integral-only} controller.
...
\begin{itemize}
\item{} Estimate the integral time constant of this controller, assuming each horizontal division is one minute in length.  ($\tau_i \approx$ 2.3 minutes)
\end{itemize}
