...
$$\includegraphics[width=15.5cm]{i03309x01.eps}$$
...
This is a {\it reverse-acting}, {\it proportional + integral} controller.
...
\begin{itemize}
\item{} Estimate the proportional band of this controller.  (PB = 100\% -- gain of 1.0)
\item{} Estimate the integral time constant of this controller, assuming each horizontal division is one minute in length.  ($\tau_i \approx$ 3 minutes)
\end{itemize}
