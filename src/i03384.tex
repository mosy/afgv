...
Suppose the solenoid valve refuses to energize when the pushbutton switch is pressed.  A voltmeter registers 0 volts between test points {\bf C} and {\bf D} in the circuit while the pushbutton is pressed:

$$\includegraphics[width=15.5cm]{i03384x01.eps}$$
