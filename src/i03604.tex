...
\itemitem{} Input bits: {\tt I} for both Siemens and Allen-Bradley
\itemitem{} Output bits: {\tt Q} for Siemens and {\tt O} for Allen-Bradley
\itemitem{} Internal bits: {\tt M} for Siemens and {\tt B} for Allen-Bradley
\itemitem{} Timer data: {\tt T} for both Siemens and Allen-Bradley
\itemitem{} Counter data: {\tt C} for both Siemens and Allen-Bradley
\itemitem{} Special data: {\tt SM} for Siemens and {\tt S} for Allen-Bradley
