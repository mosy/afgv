...
$$\includegraphics[width=15.5cm]{i03637x01.eps}$$
...
\vskip 40pt
\item{} Assuming direct action on the part of the transmitter and the motor drive, which control action ({\it direct} or {\it reverse}) should the controller be configured for?
\vskip 40pt
\item{} How will the control system respond to an {\it increase} in fresh water flow rate added to the rearing pond?
\vskip 40pt
