...
A newly constructed PLC-controlled motor starter system refuses to work -- the motor shaft does not turn after the operator presses the ``Start'' switch and waits.  After this, you measure 117 volts AC between the terminal labeled ``X1'' on the transformer's secondary winding and the terminal labeled ``A'' on the Start switch.  A laptop PC shows the PLC program as it exists in memory, but without any colored status highlighting:

$$\includegraphics[width=15.5cm]{i03659x01.eps}$$
