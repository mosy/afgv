...
A newly constructed PLC-controlled motor starter system refuses to work -- the motor shaft does not turn after the operator presses the ``Start'' switch and waits.  After this, you measure 118 volts AC between the PLC power supply's L2 terminal and the terminal labeled ``X0'' on the PLC input card.  A laptop PC shows the PLC program as it exists in memory, but without any colored status highlighting:

$$\includegraphics[width=15.5cm]{i03660x01.eps}$$
...
%
% Another row
Open wire between L2 and input card Common &  &  \cr
%
\noalign{\hrule}
%
% Another row
