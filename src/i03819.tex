...
Draw connecting wires that will create a {\it series} circuit between all three resistors, such that current (conventional flow notation) will go through each resistor as shown by the arrows:

$$\includegraphics[width=15.5cm]{i03819x01.eps}$$
...
$$\includegraphics[width=15.5cm]{i03819x02.eps}$$
