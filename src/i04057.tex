...
Suppose a turbine flowmeter used to measure the flow of natural gas has a ``K factor'' equal to 37.2 pulses per standard cubic foot (SCF).  Calculate the following:
...
The amount of time required (in units of hours and minutes) to accumulate 525,000 pulses (on a digital counter circuit) give a steady flow rate of 170 SCFM.
