...
Suppose a vortex flowmeter is used to measure the flow rate of fuel oil into a large combustion boiler.  The vortex meter has a ``K factor'' equal to 10.344 pulses per gallon.  Calculate the following:
