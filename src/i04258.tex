...
On a job you are asked to disconnect a five-conductor cable from a terminal strip in preparation for that cable's complete removal.  Another technician tells you that the other end of that cable has already been completely disconnected, and therefore there can be no dangerous voltage present on the cable.
...
$$\includegraphics[width=15.5cm]{i04258x01.eps}$$
