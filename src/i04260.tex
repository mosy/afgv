...
$$\includegraphics[width=15.5cm]{i04260x01.eps}$$

List all possible pairs of points the electrician must check for voltage between.  Don't forget to include earth ground as one of those points, in addition to L1, L2, and L3!  
