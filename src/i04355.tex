...
Sketch arrows next to each of the two solenoid valves showing the directions of air flow in the energized (E) and de-energized (D) states, assuming the process control valve is supposed to be open in regular operation and close if either of the solenoid valves ``trips'' (i.e. 1oo2 to trip):

$$\includegraphics[width=15.5cm]{i04355x01.eps}$$

\underbar{file i04355}
%(END_QUESTION)
...
$$\includegraphics[width=15.5cm]{i04355x02.eps}$$
