...
Sketch the wires necessary to connect two limit switches (normally-open contacts) to input channels {\tt Ix.3} and {\tt Ix.6} of a Siemens SM 321 discrete input card (model 6ES7321-1BL00-0AA0).  The internal schematic diagram of the first channel ({\tt Ix.0}) is shown as ``typical'' for all the channels:

$$\includegraphics[width=15.5cm]{i04536x01.eps}$$

Also, identify whether this is a {\it sinking} or a {\it sourcing} input module.
