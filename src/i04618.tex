...
Suppose this DC electric motor refuses to start as it should when the pushbutton switch is pressed.  A voltmeter subsequently connected between test points {\bf E} and {\bf D} in this circuit always registers 24 volts, whether the switch is pressed or not:

$$\includegraphics[width=15.5cm]{i04618x01.eps}$$
