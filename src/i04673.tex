...
Suppose this three-phase AC electric motor refuses to start as it should when the transistor turns on.  A voltmeter subsequently connected between test points {\bf C} and {\bf D} in this circuit registers 0 volts with the transistor biased to be in the ``on'' state:

$$\includegraphics[width=15.5cm]{i04673x01.eps}$$
