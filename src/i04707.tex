...
Suppose this three-phase AC electric motor refuses to start as it should when the transistor turns on.  A voltmeter subsequently connected between test points {\bf A} and {\bf B} in this circuit registers 24 volts with the transistor biased to be in the ``off'' state:

$$\includegraphics[width=15.5cm]{i04707x01.eps}$$
