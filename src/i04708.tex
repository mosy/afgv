...
Suppose this three-phase AC electric motor refuses to start as it should when the transistor turns on, but an audible ``thunk'' is heard from the contactor each time the transistor turns on:

$$\includegraphics[width=15.5cm]{i04708x01.eps}$$
