...
\vskip 5pt 
\oppgave{} 
Hva står følgende forkortelser for: SF, $PL_r$, $MTTF_D$
%
\vskip 2.5pt 
\begin{tikzpicture}
...
Oppgaver fra Kap 5. 
\oppgave{} 
Gjelder EC machinery Directive i norge? Eventuelt hvilken lov er det implementert i?
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,4) ;
\end{tikzpicture}
...
\oppgave{} 
Hvilken sikkerhetsstandard er viktig grunnlag for maskin direktivet?
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,4) ;
\end{tikzpicture}
...
%		○ Utførelse av nødstopp. 
	...
	\oppgave{} Hvordan bestemmes PLr for en sikkerhetsfunksjon. 
\vskip 2.5pt 
\begin{tikzpicture}
	\draw[step=0.5cm,gray!20,very thin]  grid (17,4) ;
\end{tikzpicture}
